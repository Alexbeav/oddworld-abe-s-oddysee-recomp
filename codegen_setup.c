...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Oddworld Abes Oddysee",
    .project_root_env = "ODDWORLD_ABES_ODDYSEE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "ODDWORLD_ABES_ODDYSEE_RECOMP_BUILD_DIR",
    .force_setup_env = "ODDWORLD_ABES_ODDYSEE_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_001.90_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Oddworld_Abes_Oddysee__Recompiled",
    .prepare_note =
