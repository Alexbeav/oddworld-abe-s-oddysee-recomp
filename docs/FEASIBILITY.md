# Oddworld: Abe's Oddysee feasibility binding

## Identity

- Title and region: Oddworld: Abe's Oddysee, USA.
- Serial: SLUS-00190.
- Source executable path: `disc/SLUS_001.90`.
- Load address: `0x80010000`.
- Entry point: `0x8007F794`.
- Source disc binding: `disc/Oddworld - Abe's Oddysee (USA) (Rev 2).cue`.
...
The clean source commit is `a4ef29cf26582b541ba1a42d759679a8ace5d201`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 728 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `a4ef29cf26582b541ba1a42d759679a8ace5d201`.
- Portfolio `oddworld-abe-s-oddysee/BUILDINFO.json`.
- Portfolio `oddworld-abe-s-oddysee/RECEIPT.md`.
